...
The application is in active development. It can open and scan local projects, display large file trees, and parse Python, JavaScript, TypeScript, and TSX source files with Tree-sitter. Selecting a supported file reveals its source, symbols, signatures, locations, and available documentation.
